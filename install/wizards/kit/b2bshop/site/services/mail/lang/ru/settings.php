	  ...
	  <tr>
		  <td>
			  <table cellpadding="0" cellspacing="0" style="background: #F1EEED; border-top: 1px solid #BBBBBB; margin-top: 22px; height: 246px;">
				  ...
				  <tr>
					  ...
					  <td width="223px" style="padding-top: 0px; padding-left: 20px;" valign="top">
						  ...
						  <table cellpadding="0" cellspacing="0" style="border: 1px solid #787776; background-color: #f4f3f2; padding: 9px 18px 5px 17px">
							  <tr>
								  <td style="padding-right: 8px;"><a href="https://vk.com/kit" target="_blank"><img src="#TEMPL_URL#img/mail_img/letter_b2b_shop_footer_vk.png" alt="" /></a></td>
								  <td style="padding-right: 8px;"><a href="https://www.facebook.com/kit" target="_blank"><img src="#TEMPL_URL#img/mail_img/letter_b2b_shop_footer_facebook.png" alt="" /></a></td>
								  <td style="padding-right: 8px;"><a href="https://twitter.com/kit" target="_blank"><img src="#TEMPL_URL#img/mail_img/letter_b2b_shop_footer_twitter.png" alt="" /></a></td>
				  ...
				  <tr height="30" >
					<td style="text-align:center;" colspan="3" > <a style="color: #353535; font-size: 14px" href="#SITE_URL#/?MAILING_MESSAGE=#MAILING_MESSAGE#&MAILING_UNSUBSCRIBE=#MAILING_UNSUBSCRIBE#&utm_source=newsletter&utm_medium=email&utm_campaign=kit_mailing_#MAILING_EVENT_ID#"  >Отписаться от рассылки</a></td>
				  </tr>
			  </table>
		  </td>
	  </tr>
