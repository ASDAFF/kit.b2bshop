...
COption::SetOptionString( "kit.b2bshop", "shopLocalization", $shopLocalization, "ru", WIZARD_SITE_ID );
...
if( $bRus || COption::GetOptionString( "kit.b2bshop", "wizard_installed", "N", WIZARD_SITE_ID ) != "Y" || WIZARD_INSTALL_DEMO_DATA )
{
	...
	if( $shopLocalization == "ru" )
	{
		...
		COption::SetOptionString( "kit.b2bshop", "shopLocation", $shopLocation, false, WIZARD_SITE_ID );
		$shopOfName = $wizard->GetVar( "shopOfName" );
		COption::SetOptionString( "kit.b2bshop", "shopOfName", $shopOfName, false, WIZARD_SITE_ID );
		$shopAdr = $wizard->GetVar( "shopAdr" );
		COption::SetOptionString( "kit.b2bshop", "shopAdr", $shopAdr, false, WIZARD_SITE_ID );

		$shopINN = $wizard->GetVar( "shopINN" );
		COption::SetOptionString( "kit.b2bshop", "shopINN", $shopINN, false, WIZARD_SITE_ID );
		$shopKPP = $wizard->GetVar( "shopKPP" );
		COption::SetOptionString( "kit.b2bshop", "shopKPP", $shopKPP, false, WIZARD_SITE_ID );
		$shopNS = $wizard->GetVar( "shopNS" );
		COption::SetOptionString( "kit.b2bshop", "shopNS", $shopNS, false, WIZARD_SITE_ID );
		$shopBANK = $wizard->GetVar( "shopBANK" );
		COption::SetOptionString( "kit.b2bshop", "shopBANK", $shopBANK, false, WIZARD_SITE_ID );
		$shopBANKREKV = $wizard->GetVar( "shopBANKREKV" );
		COption::SetOptionString( "kit.b2bshop", "shopBANKREKV", $shopBANKREKV, false, WIZARD_SITE_ID );
		$shopKS = $wizard->GetVar( "shopKS" );
		COption::SetOptionString( "kit.b2bshop", "shopKS", $shopKS, false, WIZARD_SITE_ID );
		$siteStamp = $wizard->GetVar( "siteStamp" );
		if( $siteStamp == "" )
			$siteStamp = COption::GetOptionString( "kit.b2bshop", "siteStamp", "", WIZARD_SITE_ID );
	}
	elseif( $shopLocalization == "ua" )
	{
		...
		COption::SetOptionString( "kit.b2bshop", "shopLocation_ua", $shopLocation, false, WIZARD_SITE_ID );
		$shopOfName = $wizard->GetVar( "shopOfName_ua" );
		COption::SetOptionString( "kit.b2bshop", "shopOfName_ua", $shopOfName, false, WIZARD_SITE_ID );
		$shopAdr = $wizard->GetVar( "shopAdr_ua" );
		COption::SetOptionString( "kit.b2bshop", "shopAdr_ua", $shopAdr, false, WIZARD_SITE_ID );

		$shopEGRPU_ua = $wizard->GetVar( "shopEGRPU_ua" );
		COption::SetOptionString( "kit.b2bshop", "shopEGRPU_ua", $shopEGRPU_ua, false, WIZARD_SITE_ID );
		$shopINN_ua = $wizard->GetVar( "shopINN_ua" );
		COption::SetOptionString( "kit.b2bshop", "shopINN_ua", $shopINN_ua, false, WIZARD_SITE_ID );
		$shopNDS_ua = $wizard->GetVar( "shopNDS_ua" );
		COption::SetOptionString( "kit.b2bshop", "shopNDS_ua", $shopNDS_ua, false, WIZARD_SITE_ID );
		$shopNS_ua = $wizard->GetVar( "shopNS_ua" );
		COption::SetOptionString( "kit.b2bshop", "shopNS_ua", $shopNS_ua, false, WIZARD_SITE_ID );
		$shopBank_ua = $wizard->GetVar( "shopBank_ua" );
		COption::SetOptionString( "kit.b2bshop", "shopBank_ua", $shopBank_ua, false, WIZARD_SITE_ID );
		$shopMFO_ua = $wizard->GetVar( "shopMFO_ua" );
		COption::SetOptionString( "kit.b2bshop", "shopMFO_ua", $shopMFO_ua, false, WIZARD_SITE_ID );
		$shopPlace_ua = $wizard->GetVar( "shopPlace_ua" );
		COption::SetOptionString( "kit.b2bshop", "shopPlace_ua", $shopPlace_ua, false, WIZARD_SITE_ID );
		$shopFIO_ua = $wizard->GetVar( "shopFIO_ua" );
		COption::SetOptionString( "kit.b2bshop", "shopFIO_ua", $shopFIO_ua, false, WIZARD_SITE_ID );
		$shopTax_ua = $wizard->GetVar( "shopTax_ua" );
		COption::SetOptionString( "kit.b2bshop", "shopTax_ua", $shopTax_ua, false, WIZARD_SITE_ID );
	}

	$siteTelephone = $wizard->GetVar( "siteTelephone" );
	COption::SetOptionString( "kit.b2bshop", "siteTelephone", $siteTelephone, false, WIZARD_SITE_ID );
	$shopEmail = $wizard->GetVar( "shopEmail" );
	COption::SetOptionString( "kit.b2bshop", "shopEmail", $shopEmail, false, WIZARD_SITE_ID );
	$siteName = $wizard->GetVar( "siteName" );
	COption::SetOptionString( "kit.b2bshop", "siteName", $siteName, false, WIZARD_SITE_ID );
	...
	if( strlen( $siteStamp ) > 0 )
	{
		if( IntVal( $siteStamp ) > 0 )
		{
			...
			if( $zr = $ff->Fetch() )
			{
				...
				COption::SetOptionString( "kit.b2bshop", "siteStamp", $siteStamp, false, WIZARD_SITE_ID );
			}
		}
	}
	else
	...
	COption::SetOptionString( "kit.b2bshop", "personTypeFiz", $personTypeFiz, false, WIZARD_SITE_ID );
	$personTypeUr = (isset( $personType["ur"] ) && $personType["ur"] == "Y" ? "Y" : "N");
	COption::SetOptionString( "kit.b2bshop", "personTypeUr", $personTypeUr, false, WIZARD_SITE_ID );
	$personTypeIp = (isset( $personType["ip"] ) && $personType["ip"] == "Y" ? "Y" : "N");
	COption::SetOptionString( "kit.b2bshop", "personTypeIp", $personTypeIp, false, WIZARD_SITE_ID );
	...
	if( $shopLocalization == "ua" )
	{
		...
		COption::SetOptionString( "kit.b2bshop", "personTypeFizUa", $personTypeFizUa, false, WIZARD_SITE_ID );
	...
	if( COption::GetOptionString( "kit.b2bshop", "wizard_installed", "N", WIZARD_SITE_ID ) != "Y" || WIZARD_INSTALL_DEMO_DATA )
	{
		...
		function __MakeOrder($prdCnt = 1, $arData = Array())
		{
			...
			$ibl = COption::GetOptionString( 'kit.b2bshop', 'IBLOCK_ID' );
