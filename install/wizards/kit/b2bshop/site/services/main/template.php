...
CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH."/bitrix/templates/b2b_shop/components/kit/catalog.smart.filter.facet/catalog/script.js", Array("SITE_DIR" => WIZARD_SITE_DIR));
CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH."/bitrix/templates/b2b_shop/components/kit/catalog.smart.filter.facet/brand/script.js", Array("SITE_DIR" => WIZARD_SITE_DIR));
CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH."/bitrix/templates/b2b_shop/components/kit/catalog.smart.filter.facet/blank/script.js", Array("SITE_DIR" => WIZARD_SITE_DIR));
