...
if(!CModule::IncludeModule("kit.mailing") || !CModule::IncludeModule("catalog") || !CModule::IncludeModule("iblock"))
    return;     
...
// START
$arrevent = array();
$dbevent = CKitMailingEvent::GetList();
...
if(empty($arrevent[GetMessage('WZD_user_register_mailing_1_NAME')])){ 
    ...
    $eventCreate[] = array(
        ...
        'EVENT_TYPE' => 'KIT_MAILING_EVENT_SEND',
...
foreach($eventCreate as $itemEvent){
    ...
    $ID_EVENT = CKitMailingEvent::Add($itemEvent);
    ...
    CKitMailingMessageTemplate::Add($arrAddTemplate);
    // END            
                          
    //�������� ����� 
    if($ID_EVENT){
        $AGENT_ID = CAgent::AddAgent('CKitMailingTools::AgentStartTemplate('.$ID_EVENT.');', "kit.mailing", "N", $itemEvent['AGENT_INTERVAL'], "", $itemEvent['AGENT_ACTIVE']);
        CKitMailingEvent::Update($ID_EVENT , array('AGENT_ID' => $AGENT_ID));
    }
...
// START
$arrcategory = array();
$dbcategory = CKitMailingCategories::GetList();
...
foreach($categoryCreate as $itemcategory){
    ...
    if(empty($arrcategory[$itemcategory['NAME']])){
        ...
        $CATEGORIES_ID = CKitMailingCategories::Add($itemcategory);
    } else {
...
//������� �������
//START 
COption::SetOptionString('kit.mailing','TEMPLATE_MAILING_DEF','/bitrix/components/kit/kit.mailing.logic/lang/ru/tpl_mailing/b2bshop.php');
CopyDirFiles(
    WIZARD_ABSOLUTE_PATH."/site/services/kit.mailing/lang/ru/tpl_mailing/",
    $_SERVER['DOCUMENT_ROOT'].'/bitrix/components/kit/kit.mailing.logic/lang/ru/tpl_mailing/',
    $rewrite = true,
    $recursive = true,
...
//������� ����������
    ...
    COption::SetOptionString("kit.b2bshop", "MAILING_CATEGORIES_ID", serialize($MAILING_CATEGORIES_ID));
