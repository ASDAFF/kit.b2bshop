...
рассылки</a></p>
                      ...
                      <td width="223px" style="padding-top: 0px; padding-left:30px;" valign="top">
                          ...
                          <table cellpadding="0" cellspacing="0" style="padding: 9px 18px 5px 0;">
                              <tr>
                                  <td style="padding-right: 8px;"><a href="https://vk.com/kit" target="_blank" style="background: url(\'#SITE_URL#/bitrix/templates/b2b_shop/img/mail_img/mister_sprite_social_icon.png\');background-position: -5px -5px;width:30px;height: 31px;display: block;"></a></td>
                                  <td style="padding-right: 8px;"><a href="https://www.facebook.com/kit" target="_blank"  style="background: url(\'#SITE_URL#/bitrix/templates/b2b_shop/img/mail_img/mister_sprite_social_icon.png\');background-position: -5px -75px;width:30px;height: 31px;display: block;"></a></td>
                                  <td style="padding-right: 8px;"><a href="https://twitter.com/kit" target="_blank" style="background: url(\'#SITE_URL#/bitrix/templates/b2b_shop/img/mail_img/mister_sprite_social_icon.png\');background-position: -5px -145px;width:30px;height: 31px;display: block;"></a></td>
