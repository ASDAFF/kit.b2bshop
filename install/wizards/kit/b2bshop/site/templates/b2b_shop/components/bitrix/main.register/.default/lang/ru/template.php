...
$MESS["REGISTER_CONFIDENTIAL"] = 'Нажимая на кнопку «Регистрация», я даю согласие на обработку персональных данных и соглашаюсь c <a href="'.\Bitrix\Main\Config\Option::get("kit.b2bshop", "CONFIDENTIAL_URL","/help/confidentiality/").'" target="_blank">политикой конфиденциальности</a>.';
