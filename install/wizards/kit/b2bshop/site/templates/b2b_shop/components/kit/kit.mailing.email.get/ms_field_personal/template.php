	...
	<div id="wrapper_blank_resizer" class="wrapper_blank_resizer">
		...
		<div class="personal-right-content">
			<div class="personal_block_subscribe">
				<form  method="post" action="#" id="kit_mailing_subsrib">
							...
							<div class="col-sm-12">
								<div class="block_subscribe_left">
									...
									<div class="row">
										...
										<div class="col-sm-10">
											<div class="kit_mailing_subscr_wrap_answer"></div>
										</div>
									</div>
								</div>
							</div>
...
$("#kit_mailing_subsrib").on('submit', function(){

	var email = $("#kit_mailing_subsrib input[name=EMAIL_TO]").val();
	...
	if(pattern.test(email)) {
		...
		BX.ajax({
			...
			onsuccess: function(data){
				$('.kit_mailing_subscr_wrap_answer').html('<label style="color:green"><?=$EMAIL_SEND_END?></label>');
			},
		});
