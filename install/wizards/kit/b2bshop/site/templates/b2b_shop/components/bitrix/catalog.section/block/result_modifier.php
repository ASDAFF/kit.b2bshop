...
//$section = new Kit\B2BShop\Client\Shop\Section($arResult, $arParams, array());
...
if ($arParams['COLOR_IN_PRODUCT'] == 'Y' && $arParams["COLOR_IN_SECTION_LINK"] == 2 && $arParams["COLOR_IN_PRODUCT_LINK"])
{
	...
	{
		$ColorLink2 = B2BSKitShop::ColorLink2($arModelsLinks,$arParams["COLOR_IN_PRODUCT_LINK"],$arParams['COLOR_IN_PRODUCT_CODE'],$colorCode,$arParams["LIST_WIDTH_SMALL"],$arParams["LIST_HEIGHT_MEDIUM"],$arParams["LIST_WIDTH_MEDIUM"],$arParams["LIST_HEIGHT_MEDIUM"],$ResizeMode, $arParams['IBLOCK_ID']);
