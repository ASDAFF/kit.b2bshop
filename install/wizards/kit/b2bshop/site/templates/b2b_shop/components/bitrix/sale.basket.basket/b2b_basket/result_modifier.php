...
$colorCode = Option::get('kit.b2bshop','OFFER_COLOR_PROP','');
...
if($offers)
{
	$propArticul = Option::get('kit.b2bshop','OPT_ARTICUL_PROP_OFFER','');
	if($propArticul)
	{
...
if($products)
{
	$propArticul = Option::get('kit.b2bshop','OPT_ARTICUL_PROP','');
	if($propArticul)
	{
