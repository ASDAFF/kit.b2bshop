...
<?
$ElementTemplate = Bitrix\Main\Config\Option::get( 'kit.b2bshop', 'ELEMENT_TEMPLATE', '.default' );
if( $ElementTemplate == 'other' )
{
	$ElementTemplate = Bitrix\Main\Config\Option::get( 'kit.b2bshop', 'ELEMENT_TEMPLATE_OTHER', '.default' );
}
?>
...
<div class='col-sm-24'>
	<div class='row detail_page_wrap no_preview <?=str_replace('.','',$ElementTemplate)?>'>
		...
		$arDetailParams = array(
				...
				'FULL_WIDTH_DESCRIPTION' => \Bitrix\Main\Config\Option::get( 'kit.b2bshop', 'FULL_WIDTH_DESCRIPTION', 'N' ),
		...
		$APPLICATION->IncludeComponent( 'kit:reviews', 'bootstrap',
				Array(
						'ADD_REVIEW_PLACE' => '1',
						'AJAX_MODE' => 'Y',
						'BUTTON_BACKGROUND' => "url('". SITE_DIR . "bitrix/components/kit/reviews.comments.add/templates/bootstrap/images/button.jpg') left top no-repeat #dbbfb9",
						'CACHE_TIME' => '36000000',
						'CACHE_TYPE' => 'A',
	...
	if( !defined( 'ERROR_404' ) )
	{
		...
		if(\Bitrix\Main\Config\Option::get('kit.b2bshop', 'SHOW_YOU_LOOK_ELEMENT_UNDER','Y') == 'Y')
		{
		...
		if(\Bitrix\Main\Config\Option::get('kit.b2bshop', 'SHOW_BIG_DATA_ELEMENT_UNDER','Y') == 'Y' && \Bitrix\Main\Config\Option::get('main', 'gather_catalog_stat','N') == 'Y' && is_dir($server->getDocumentRoot().$server->getPersonalRoot().'/components/bitrix/catalog.bigdata.products'))
		{
