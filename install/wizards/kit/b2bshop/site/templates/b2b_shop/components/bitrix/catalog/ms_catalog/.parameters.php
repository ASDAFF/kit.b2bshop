...
$arTemplateParameters["COLOR_FROM_IMAGE"] = array(
        "PARENT" => "MISS_SHOP",
        "NAME" => GetMessage('MS_TPL_COLOR_FROM_IMAGE'),
        "TYPE" => "CHECKBOX",
        'REFRESH' => 'N',
        "DEFAULT" => "Y"
);
$arTemplateParameters['COLOR_IMAGE_WIDTH'] = array(
			'PARENT' => 'MISS_SHOP',
			'NAME' => GetMessage('MS_TPL_COLOR_IMAGE_WIDTH'),
			'TYPE' => 'STRING',
			'DEFAULT' => '37'
);
$arTemplateParameters['COLOR_IMAGE_HEIGHT'] = array(
			'PARENT' => 'MISS_SHOP',
			'NAME' => GetMessage('MS_TPL_COLOR_IMAGE_HEIGHT'),
			'TYPE' => 'STRING',
			'DEFAULT' => '100'
);
