...
$buyers = [];
$pt = unserialize(Bitrix\Main\Config\Option::get("kit.b2bshop","BUYER_PERSONAL_TYPE","a:0:{}"));
if(!is_array($pt))
{
	$pt = [];
}
...
$orgProps = unserialize(Bitrix\Main\Config\Option::get('kit.b2bshop', 'ORDER_PROP_ORG_NAME'));
