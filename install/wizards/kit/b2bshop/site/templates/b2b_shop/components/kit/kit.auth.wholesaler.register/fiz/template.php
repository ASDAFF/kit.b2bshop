...
if(Option::get('kit.b2bshop','CLOSE_FIZ','N') != 'N')
{
	LocalRedirect(SITE_DIR.'personal/b2b/auth/');
}
				...
				<noindex>
					<form method="post" action="<?=POST_FORM_ACTION_URI ?>" name="bform" class="register-form"
						...
						<input type="hidden" id="LOGIN" name="REGISTER[LOGIN]" maxlength="50"
						       value="1<?//=$arResult["VALUES"]['FIELDS']['LOGIN']
							   ?>"/>
						<div class="tabs">
							...
							<label for="tab1" class="tab1">
								...
								<?php echo Loc::getMessage('KIT_AUTH_TAB1'); ?>
							</label>
							<a href="<?=SITE_DIR.'personal/b2b/auth/'?>">
								<input id="tab2" type="radio" name="TAB" value="WHOLESALER">
								<label class="tab2">
									<div class="tab-icon"></div>
									<?php echo Loc::getMessage('KIT_AUTH_TAB2'); ?>
								</label>
							</a>
						...
						<div class="wrap_registr_form_2 buttons_under_tabs">
							<div class="row">
								<div class="col-sm-24">
									<div class="wrap_btn">
										<input type="submit" name="kit_auth_register"
