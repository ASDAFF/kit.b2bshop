...
$maskProps = unserialize(Option::get( 'kit.b2bshop', 'MASK_ORDER_PROPS', '' ));
...
{
	$innProps = unserialize(Option::get('kit.b2bshop', 'ORDER_PROP_INN'));
	if(!is_array($innProps))
	{
		$innProps = [];
	}
	$orgProps = unserialize(Option::get('kit.b2bshop', 'ORDER_PROP_ORG_NAME'));
