...
$ID = COption::GetOptionString("kit.b2bshop", "IBLOCK_ID", "");
$OFFER_IBLOCK_ID = COption::GetOptionString("kit.b2bshop", "OFFER_IBLOCK_ID", "");
...
$APPLICATION->IncludeComponent("bitrix:catalog.viewed.products", "catalog", array(
	...
	"DETAIL_URL" => "",
	"SHOW_OLD_PRICE" => "N",
	'OFFER_TREE_PROPS_'.$ID => unserialize(COption::GetOptionString("kit.b2bshop", "OFFER_TREE_PROPS", "")),
	...
	"OFFER_TREE_PROPS_".$OFFER_IBLOCK_ID => unserialize(COption::GetOptionString("kit.b2bshop", "OFFER_TREE_PROPS", "")),
	"CART_PROPERTIES_".$ID => array(
		0 => "",
		1 => "",
	),
	"ADDITIONAL_PICT_PROP_".$ID => COption::GetOptionString("kit.b2bshop", "MORE_PHOTO_PRODUCT_PROPS", ""),
	"LABEL_PROP_70" => "-",
	...
	"LABEL_PROP_3" => "-",
	"OBJECTIVE_IBLOCK_TYPE" => COption::GetOptionString("kit.b2bshop", "IBLOCK_TYPE", ""),
	"OBJECTIVE_IBLOCK_ID" => COption::GetOptionString("kit.b2bshop", "IBLOCK_ID", ""),
	"OFFER_COLOR_PROP" => COption::GetOptionString("kit.b2bshop", "OFFER_COLOR_PROP", ""),
	"MANUFACTURER_ELEMENT_PROPS" => COption::GetOptionString("kit.b2bshop", "MANUFACTURER_ELEMENT_PROPS", ""),
	"MANUFACTURER_LIST_PROPS" => COption::GetOptionString("kit.b2bshop", "MANUFACTURER_LIST_PROPS", ""),
	"FLAG_PROPS" => unserialize(COption::GetOptionString("kit.b2bshop", "FLAG_PROPS", "")),
