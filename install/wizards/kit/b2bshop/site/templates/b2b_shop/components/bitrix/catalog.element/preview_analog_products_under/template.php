...
<div class="bootstrap_style detail_page_wrap preview content-text analog_products_under" id="analog_products_under" style="overflow: hidden">
				...
				<div class="detail_block_buy">
					...
					<div class="available-container">
						<div class="block-right-column">
							...
							if($isPhone=="Y"):
								?>
								<?$APPLICATION->IncludeComponent("kit:order.phone", "catalog_preview", array(
...
<div class="row modification-under-preview desc-analog-products-under">
...
var msDetail = new msDetailProduct({
	...
	"image2need" : <?=CUtil::PhpToJSObject($arResult['COLOR_OFFER_FROM_IMAGE'])?>,
		...
		"contPrev" : ".list_left",
		"contNext" : ".list_right",
		"contSelectProps" : ".detail_page_wrap.preview .kit_order_phone form input:submit",
