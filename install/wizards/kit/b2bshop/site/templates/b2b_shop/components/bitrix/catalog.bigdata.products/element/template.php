...
{
	global $showElementBottomBlock;
	$showElementBottomBlock = true;
...
if( !empty( $arResult['ITEMS'] ) )
{
	...
	<script type="text/javascript">
		$(function() {
			if($("#block-bigdata-element").length)
			{
				$('#block-bigdata-element').css({'width': '100%'});
				$('#block-bigdata-element .item').css({'float': 'none'});
				$("#block-bigdata-element").owlCarousel({
					nav:true,
					smartSpeed:400,
					dots:false,
					 navText:["", ""],
		...
		$(function() {
			var msListPV = new msListProduct({
				...
				"listBlock" : "#block-bigdata-element",
				"listItem" : ".one-item",
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-24 sm-padding-no">
					<div class="block_you_look_big block-bigdata-element_wrapper">
						<h2 class="title"><?=GetMessage("MS_PV_BIG_DATA_SECTION")?></h2>
						<div class="block_you_look_big_bg"></div>
						<div class="wrap-block-you-slider">
							<div id="block-bigdata-element" class="block-you-slider block-bigdata-element">
								<?
