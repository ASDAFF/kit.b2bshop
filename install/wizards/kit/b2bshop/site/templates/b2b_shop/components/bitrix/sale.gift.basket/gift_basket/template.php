...
<?
	...
	$rand = $arResult["RAND"];
	?>
	<div class="gift-basket-wrapper">
		<div class="col-sm-24 col-gift-basket">
			<div class="description_block block_open">
			<div class="description_title button_js">
				<div class="description_title_in">
					<span class="desc_fly_1_bg"><div class="img-giftbasket"></div><?=GetMessage("MS_MAIN_GIFT")?></span>
				</div>
			</div>
<div class="description_content block_js">
			<div id="block-giftbasket" class="block-giftbasket">
            <?
	...
	foreach ( $arResult['ITEMS'] as $arItem ):
		...
		$propName = "";
		?>
<div class="one-item-wrapper col-sm-6" >
...
<div class="js_detail_prop_block">
	                                    <?foreach($arResult["OFFER_TREE_PROPS"][$ID] as $codeProp=>$arProperties):
	                                        ...
	                                        if($colorCode==$codeProp || !in_array($codeProp,unserialize(COption::GetOptionString("kit.b2bshop", "OFFER_TREE_PROPS", "")))) continue;
	                                        //END OFFER_PROPS
	                                        ?>
...
$(function() {
    var msGift = new msGiftBasket({
        "SITE_ID" : "<?=$siteID?>",

        "toggle" : ".gift-basket-wrapper .button_js",
        ...
        "main" : ".block-giftbasket",
        "gift":".gift-basket-wrapper",
        "prop_img":".block-giftbasket .small_img_js ",
        ...
        "add_url" : ".block-giftbasket .btn_add_basket_gift",
        "add_wish" : ".block-giftbasket .btn_add_wish_gift",
        ...
        "submit_subscribe" : ".gift-basket-wrapper .subscribe_new_form .submit",
