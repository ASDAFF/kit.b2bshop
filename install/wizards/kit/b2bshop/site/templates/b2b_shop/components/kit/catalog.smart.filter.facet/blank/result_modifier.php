...
foreach($arResult["ITEMS"] as $Item)
{
	foreach($Item["VALUES"] as $val => $ar)
	{
		if($ar["CHECKED"])
		{
			$arResult['CHECKED'][$Item['CODE']]['NAME'] = $Item['NAME'];
			++$arResult['CHECKED'][$Item['CODE']]['QNT'];
		}
	}
	if($Item['PRICE'] && (isset($Item['VALUES']['MIN']['HTML_VALUE']) || isset($Item['VALUES']['MIN']['HTML_VALUE'])))
	{
		$arResult['CHECKED'][$Item['CODE']]['NAME'] = $Item['NAME'];
		$arResult['CHECKED'][$Item['CODE']]['QNT'] = ((isset($Item['VALUES']['MIN']['HTML_VALUE']))?$Item['VALUES']['MIN']['HTML_VALUE']:$Item['VALUES']['MIN']['VALUE']).' - '.((isset($Item['VALUES']['MAX']['HTML_VALUE']))?$Item['VALUES']['MAX']['HTML_VALUE']:$Item['VALUES']['MAX']['VALUE']);
	}
}
