...
<div class="filter_news">
    ...
    <?foreach($arResult["ALL_SECTION"] as $arSection):?>
        <a class="link_section <?if($cur_page == $arSection["SECTION_PAGE_URL"]):?>link_active<?endif;?>" href="<?=$arSection['SECTION_PAGE_URL']?>"><?=$arSection['NAME']?></a>
    <?endforeach;?>
        <a class="link_section <?if($cur_page == $arResult["FOLDER"]):?>link_active<?endif;?>" href="<?=$arResult["FOLDER"]?>"><?=GetMessage('NEWS_CATEGORIES_ALL');?></a>
</div>
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
        ...
        "LIST_HEIGHT_IMG" => $arParams["LIST_HEIGHT_IMG"],
        "LIST_WIDTH_IMG" =>  $arParams["LIST_WIDTH_IMG"],
        "PAGER_MORE_NEWS" => $arParams["PAGER_MORE_NEWS"],
        "PAGER_MORE_NEWS_TEXT" =>  $arParams["PAGER_MORE_NEWS_TEXT"],
        "LIST_GO_DETAIL_PAGE" =>  $arParams["LIST_GO_DETAIL_PAGE"],
	),
	$component
);?>
