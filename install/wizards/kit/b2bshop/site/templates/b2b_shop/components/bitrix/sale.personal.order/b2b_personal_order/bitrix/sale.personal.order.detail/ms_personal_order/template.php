					...
					<div class="table_detail_order">
						...
						<div class="table_body">
							<div class="wrap_block_text">
								<div class="row">
									<div class="col-sm-17 xs-padding-left-no">
										<div class="wrap_prop">
											<div class="col-sm-9">
												<p class="prop_name"><?=\Bitrix\Main\Localization\Loc::getMessage('SPOD_ORDER_STATUS')?>:</p>
											</div>
										...
										<div class="wrap_prop">
											<div class="col-sm-9">
												<p class="prop_name"><?=\Bitrix\Main\Localization\Loc::getMessage('SPOD_ORDER_PRICE')?>:</p>
											</div>
											<div class="col-sm-15 sm-padding-left-no">
												<p class="prop_text">
										...
										<?if($arResult["CANCELED"] == "Y" || $arResult["CAN_CANCEL"] == "Y"):?>
											<div class="wrap_prop">
												<div class="col-sm-9">
													<p class="prop_name"><?=\Bitrix\Main\Localization\Loc::getMessage('SPOD_ORDER_CANCELED')?>:</p>
												</div>
												<div class="col-sm-15 sm-padding-left-no">
													<p class="prop_text">
									...
									<div class="col-sm-7">
										<?if($arResult["CAN_CANCEL"] == "Y"):?>
											<a class="order_cancel" href="<?=$arResult["URL_TO_CANCEL"]?>"><?=\Bitrix\Main\Localization\Loc::getMessage("SPOD_ORDER_CANCEL")?></a>
										<?endif?>
										<a class="order_cancel" href="<?php echo $arResult['URL_TO_COPY']?>"><?php echo \Bitrix\Main\Localization\Loc::getMessage("SPOD_ORDER_REPEAT")?></a>
									</div>
								</div>
							</div>
							...
							{?>
								...
								<div class="wrap_block_text">
									<?if(strlen($arResult["USER_NAME"])):?>
										<div class="row">
											<div class="col-sm-6">
												<p class="prop_name"><?=\Bitrix\Main\Localization\Loc::getMessage('SPOD_ACCOUNT')?>:</p>
											</div>
									...
									<div class="row">
										<div class="col-sm-6">
											<p class="prop_name"><?=\Bitrix\Main\Localization\Loc::getMessage('SPOD_LOGIN')?>:</p>
										</div>
										<div class="col-sm-11 sm-padding-left-no">
									...
									<div class="row">
										<div class="col-sm-6">
											<p class="prop_name"><?=\Bitrix\Main\Localization\Loc::getMessage('SPOD_EMAIL')?>:</p>
										</div>
										<div class="col-sm-11 sm-padding-left-no">
							...
							<div class="wrap_block_text">
								<div class="row">
									<div class="col-sm-6">
										<p class="prop_name"><?=\Bitrix\Main\Localization\Loc::getMessage('SPOD_ORDER_PERS_TYPE')?>:</p>
									</div>
									<div class="col-sm-11 sm-padding-left-no">
								...
								{?>
									...
									<div class="row">
										<div class="col-sm-6">
											<p class="prop_name"><?=\Bitrix\Main\Localization\Loc::getMessage('SPOD_ORDER_USER_COMMENT')?>:</p>
										</div>
										<div class="col-sm-11 sm-padding-left-no">
												...
												<div class="col-sm-24">
															...
															)
													{
														...
														<div class="sale-order-detail-payment-options-methods-info">
															...
															<span id="<?=$arResult['PAYMENT'][$key]['ACCOUNT_NUMBER']?>" class="sale-order-detail-payment-options-methods-info-change-link"><?=\Bitrix\Main\Localization\Loc::getMessage('SPOD_CHANGE_PAYMENT_TYPE')?></span>
														</div>
														<?
														if($arResult['PAYMENT'][$key]['PAY_SYSTEM']['ACTION_FILE'] == 'billkit')
														{
															...
															<div class="data_block">
																<div class="row">
																	<div class="col-sm-24">
																		<div class="fild">
																			<p class="name_fild">
																				<?=\Bitrix\Main\Localization\Loc::getMessage("SHOW_BILL",array('#ORDER_ID#'=>$arResult["ID"], '#PAYMENT_ID#'=>$PaymentId)) ?>
																			</p>
																			<p class="name_fild">
																				<?=\Bitrix\Main\Localization\Loc::getMessage("DOWNLOAD_BILL",array('#ORDER_ID#'=>$arResult["ID"],'#PAYMENT_ID#'=>$PaymentId)) ?>
																			</p>
																		</div>
																	</div>
																</div>
							...
							if ($arResult['SHIPMENT'])
							{
								...
								<div class="wrap_block_text">
									...
									foreach ($arResult['SHIPMENT'] as $i => $shipment)
									{
										...
										<div class="row">
											<div class="col-sm-6">
												<p class="prop_name"><?=\Bitrix\Main\Localization\Loc::getMessage("SPOD_ORDER_DELIVERY")?>:</p>
											</div>
											<div class="col-sm-11 sm-padding-left-no">
												<p class="prop_text">
												...
												<div class="col-sm-6">
													<div class="bx_ol_store">
														<div class="bx_old_s_row_title">
															<?=\Bitrix\Main\Localization\Loc::getMessage('SPOD_TAKE_FROM_STORE')?>: <b><?=$store['TITLE']?></b>
														...
														{?>
															<div class="bx_old_s_row">
																<b><?=\Bitrix\Main\Localization\Loc::getMessage('SPOD_STORE_EMAIL')?></b>: <a href="mailto:<?=$store['EMAIL']?>"><?=$store['EMAIL']?></a>
															</div>
														<?}?>
													</div>
												</div>
										...
										<div class="row">
											<div class="col-sm-6">
												<p class="prop_name"><?=\Bitrix\Main\Localization\Loc::getMessage("SPOD_ORDER_SHIPMENT_STATUS")?>:</p>
											</div>
											<div class="col-sm-11 sm-padding-left-no">
												<p class="prop_text">
										...
										<div class="row">
											<div class="col-sm-6">
												<p class="prop_name"><?=\Bitrix\Main\Localization\Loc::getMessage("SPOD_SUB_PRICE_DELIVERY")?>:</p>
											</div>
											<div class="col-sm-11 sm-padding-left-no">
												<p class="prop_text">
										...
										<?php if($shipment['TRACKING_NUMBER'])
										{
											...
											<div class="row">
												<div class="col-sm-6">
													<p class="prop_name"><?=\Bitrix\Main\Localization\Loc::getMessage("SPOD_ORDER_TRACKING_NUMBER")?>:</p>
												</div>
												<div class="col-sm-11 sm-padding-left-no">
													<p class="prop_text">
					...
					<div class="personal_order_item">
								...
								<div id="item_<?echo ($key+1);?>" class="basket_item">
									<div class="row">
										...
										<div class='col-sm-2 col-md-5'>
											<?if($hasLink)
											{?>
												<a class="basket_item_img" href="<?=$prod["DETAIL_PAGE_URL"]?>" target="_blank">
											<?}?>
											<?if($prod['PICTURE']['src'])
											{?>
													<span class="basket_item_img">
														<img class="img-responsive" src="<?=$prod['PICTURE']['src']?>" width="<?=$prod['PICTURE']['width']?>" height="<?=$prod['PICTURE']['height']?>" alt="<?=$prod['NAME']?>" />
													</span>
											<?}
											else{
											?>
													<span class="basket_item_img">
														<img class="img-responsive" src="/upload/no_photo.jpg" width="80" height="120" alt="<?=$prod['NAME']?>" />
													</span>
											<?}?>
											<?if($hasLink)
											{?>
											...
											{?>
												...
												<div class="item_prop">
													...
													?>
														...
														{?>
															<p><?=$prop["NAME"]?>: <span class="black"><?=$prop["VALUE"]?></span></p>
														<?}?>
													<?}?>
												</div>
											<?}?>
										...
										<div class='col-sm-3 sm-padding-left-no'>
											<p class="mobile_title"><?=\Bitrix\Main\Localization\Loc::getMessage('SPOD_QUANTITY')?>:</p>
										...
										<div class='col-sm-4 sm-padding-right-no'>
											<p class="mobile_title"><?=\Bitrix\Main\Localization\Loc::getMessage('SPOD_PRICE')?>:</p>
										...
										<div class='col-sm-3'>
											...
											{?>
												<p class="mobile_title"><?=\Bitrix\Main\Localization\Loc::getMessage('SPOD_DISCOUNT')?>:</p>
										...
										<div class='col-sm-4 sm-padding-left-no'>
											<p class="mobile_title"><?=\Bitrix\Main\Localization\Loc::getMessage('SPOD_SUMMARY')?>:</p>
						...
						<div class="row">
							<div class="col-sm-24 col-md-6 col-lg-7 hidden-sm hidden-xs sm-padding-right-no">
								<a class="personal_order_back" href="<?=$arResult["URL_TO_LIST"]?>" rel="nofollow"><?=\Bitrix\Main\Localization\Loc::getMessage('SPOD_GO_BACK')?></a>
							</div>
											...
											<div class="personal_order_wrap">
												<div class="row">
													<div class="col-sm-6 sm-padding-right-no">
														<p class="order_prop"><span><?=\Bitrix\Main\Localization\Loc::getMessage('SPOD_TOTAL_WEIGHT')?>:</span> <b><?=$arResult['ORDER_WEIGHT_FORMATED']?></b></p>
													</div>
													<div class="col-sm-6 sm-padding-left-no">
														<p class="order_prop"><span><?=\Bitrix\Main\Localization\Loc::getMessage('SPOD_PRODUCT_SUM')?>:</span> <b><?=$arResult['PRODUCT_SUM_FORMATTED']?></b></p>
													</div>
													<div class="col-sm-6 sm-padding-left-no">
														<?if(strlen($arResult["PRICE_DELIVERY_FORMATED"]))
														{?>
															<p class="order_prop"><span><?=\Bitrix\Main\Localization\Loc::getMessage('SPOD_DELIVERY')?>:</span> <b><?=$arResult["PRICE_DELIVERY_FORMATED"]?></b></p>
														<?}?>
													</div>
													<div class="col-sm-6 sm-padding-no">
														<p class="order_prop order_prop_price"><span><?=\Bitrix\Main\Localization\Loc::getMessage('SPOD_SUMMARY')?>:</span> <b><?=$arResult["PRICE_FORMATED"]?></b></p>
													</div>
												</div>
											</div>
										</div>
...
$HeadersSum = array(
		'TOTAL_WEIGHT'=>array('TITLE'=>\Bitrix\Main\Localization\Loc::getMessage('SPOD_TOTAL_WEIGHT'),'VALUE'=>$arResult['ORDER_WEIGHT_FORMATED']),
		'PRODUCT_SUM'=>array('TITLE'=>\Bitrix\Main\Localization\Loc::getMessage('SPOD_PRODUCT_SUM'),'VALUE'=>$arResult['PRODUCT_SUM_FORMATTED']),
		'DELIVERY'=>array('TITLE'=>\Bitrix\Main\Localization\Loc::getMessage('SPOD_DELIVERY'),'VALUE'=>$arResult["PRICE_DELIVERY_FORMATED"]),
		'SUMMARY'=>array('TITLE'=>\Bitrix\Main\Localization\Loc::getMessage('SPOD_SUMMARY'),'VALUE'=>$arResult["PRICE_FORMATED"]),
);
?>
