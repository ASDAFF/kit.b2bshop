...
<?php
if(Option::get("kit.b2bshop", "SHOW_PHONES", "Y") != 'Y')
{
	?>
...
if(Option::get('kit.b2bshop', 'LAZY_LOAD','N') == 'Y')
{
...
if(Option::get("kit.b2bshop", "STYLE", "default")=="default")
{
...
if(COption::GetOptionString( "kit.b2bshop", "SHOW_BRICKS", "N" ) == 'Y')
{
...
<![endif]-->
<?
$AddFiles = unserialize(Option::get("kit.b2bshop", "ADD_FILES", "a:0:{}"));
