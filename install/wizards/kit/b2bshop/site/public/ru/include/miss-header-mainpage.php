...
$BANNER_IBLOCK_TYPE = Option::get( "kit.b2bshop", "BANNER_IBLOCK_TYPE", "" );
...
$PriceCode = ($_SESSION["KIT_REGIONS"]["PRICE_CODE"] & COption::GetOptionString("kit.b2bshop","USE_MULTIREGIONS","Y") == 'Y')
	?$_SESSION["KIT_REGIONS"]["PRICE_CODE"]:unserialize(COption::GetOptionString("kit.b2bshop","PRICE_CODE",""));
$context = \Bitrix\Main\Application::getInstance()->getContext();
$server = $context->getServer();
if( \Bitrix\Main\Config\Option::get( "kit.b2bshop", "SHOW_BIG_DATA_MAINPAGE", "Y" ) == 'Y' && \Bitrix\Main\Config\Option::get( "main", "gather_catalog_stat", "N" ) == 'Y' && is_dir(
...
if( \Bitrix\Main\Config\Option::get( "kit.b2bshop", "SHOW_BUYING_MAINPAGE", "Y" ) == 'Y')
{
	$APPLICATION->IncludeComponent( "shs:shs.onlinebuyers", "main", 
			array(
					...
					"PRODUCT_QUANTITY_VARIABLE" => "quantity",
					"PROPERTY_CODE" => array(
							0 => Option::get( "kit.b2bshop", "MORE_PHOTO_PRODUCT_PROPS", "" ),
					),
...
$NEWS_IBLOCK_TYPE = Option::get( "kit.b2bshop", "NEWS_IBLOCK_TYPE", "" );
$NEWS_IBLOCK_ID = Option::get( "kit.b2bshop", "NEWS_IBLOCK_ID", "" );
