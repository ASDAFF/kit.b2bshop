...
$APPLICATION->IncludeComponent(
		...
		Array(
				...
				"COLOR_IMAGE_HEIGHT" => COption::GetOptionString("kit.b2bshop","COLOR_IMAGE_HEIGHT","100"),
				"COLOR_IMAGE_WIDTH" => COption::GetOptionString("kit.b2bshop","COLOR_IMAGE_WIDTH","37"),
				...
				"COLOR_SLIDER_COUNT_IMAGES_HOR" => COption::GetOptionString("kit.b2bshop","COLOR_SLIDER_COUNT_IMAGES_HOR","0"),
				"COLOR_SLIDER_COUNT_IMAGES_VER" => COption::GetOptionString("kit.b2bshop","COLOR_SLIDER_COUNT_IMAGES_VER","0"),
				"CONVERT_CURRENCY" => "Y",
				"CURRENCY_ID" => "",
				...
				"DETAIL_OFFERS_PROPERTY_CODE" => unserialize(COption::GetOptionString("kit.b2bshop","OPT_OFFER_TREE_PROPS","")),
				...
				"IBLOCK_ID" => COption::GetOptionString("kit.b2bshop","OPT_IBLOCK_ID",""),
				"IBLOCK_TYPE" => COption::GetOptionString("kit.b2bshop","OPT_IBLOCK_TYPE",""),
				...
				"LIST_OFFERS_LIMIT" => "0",
				"LIST_OFFERS_PROPERTY_CODE" => unserialize(COption::GetOptionString("kit.b2bshop","OPT_PROPS","")),
				...
				"MODIFICATION" => COption::GetOptionString("kit.b2bshop","MODIFICATION",""),
				"MODIFICATION_COUNT" => COption::GetOptionString("kit.b2bshop","MODIFICATION_COUNT","4"),
				...
				"OFFERS_CART_PROPERTIES" => unserialize(COption::GetOptionString("kit.b2bshop","OPT_OFFER_TREE_PROPS","")),
				...
				"OFFER_ELEMENT_PROPS" => unserialize(COption::GetOptionString("kit.b2bshop","OFFER_ELEMENT_PROPS","")),
				"OFFER_TREE_PROPS" => unserialize(COption::GetOptionString("kit.b2bshop","OPT_PROPS","")),
				'OPT_FILTER_PROPERTIES' => unserialize(COption::GetOptionString("kit.b2bshop","OPT_FILTER_FIELDS","")),
				'OPT_ARTICUL_PROPERTY' => COption::GetOptionString("kit.b2bshop","OPT_ARTICUL_PROP",""),
				'OPT_ARTICUL_PROPERTY_OFFER' => COption::GetOptionString("kit.b2bshop","OPT_ARTICUL_PROP_OFFER",""),
				'OPT_UNIQUE_PROP' => COption::GetOptionString("kit.b2bshop","OPT_UNIQUE_PROP","CODE"),
				...
				"PAGE_ELEMENT_COUNT" => COption::GetOptionString("kit.b2bshop","CATALOG_LIST_COUNT","12"),
				...
				"USE_ALSO_BUY" => "Y",
				'USE_BIG_DATA' => 'Y',
				'USE_BRICKS' => COption::GetOptionString("kit.b2bshop","SHOW_BRICKS","N"),
				"USE_CAPTCHA" => "Y",
				"USE_COMPARE" => "N",
