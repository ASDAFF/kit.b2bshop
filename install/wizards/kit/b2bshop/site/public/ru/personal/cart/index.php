...
<?$APPLICATION->IncludeComponent(
	...
	(Loader::includeModule('kit.b2bshop')?"b2b_basket":"ms_basket"),
    array(
        "OFFERS_PROPS" => unserialize(COption::GetOptionString("kit.b2bshop", "OFFER_TREE_PROPS", "")),
        /*array(
            0 => "RAZMER_ATTR_S_DIRECTORY",
            1 => "TSVET_ATTR_S_DIRECTORY",
        ),*/
        "PATH_TO_ORDER" => COption::GetOptionString("kit.b2bshop", "URL_ORDER", ""),
        "HIDE_COUPON" => "N",
        "COLUMNS_LIST" => array(
            0 => "NAME",
            1 => "DISCOUNT",
        ...
        "IMG_WIDTH" => COption::GetOptionString("kit.b2bshop", "CART_IMG_WIDTH", ""),
        "IMG_HEIGHT" => COption::GetOptionString("kit.b2bshop", "CART_IMG_HEIGHT", "")
    ),
    false
);?>
