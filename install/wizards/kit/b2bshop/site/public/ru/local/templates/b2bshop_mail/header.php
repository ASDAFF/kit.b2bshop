                        ...
                        <td align="center" width="35%">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin:0; padding:0">
                                <tr >
                                    <td width="100%">
                            <![endif]-->
                             <a href="http://b2bshop.kit.ru" target="_blank" style=""><img src='<?=COption::GetOptionString("kit.b2bshop","LOGO","")?>' alt="" border="0" width="161" style="display:block;text-decoration:none; outline:none;"></a>
                            <!--[if gte mso 9]>
                            </td>
                            </tr>
                            </table>
                                        ...
                                        <td width="80%" align="right" cellpadding="0" cellspacing="0" border="0">
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin:0; padding:0">
                                                <tr cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <td width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <![endif]-->
                                        <a href='<?=COption::GetOptionString("kit.b2bshop","EMAIL","")?>' target="_blank" style="font: 16px 'Proxima Nova', Arial, sans-serif;color: #000000;font-weight: bold;text-decoration: none;line-height:30px;display: block; -webkit-text-size-adjust:none;"><font color="#000000" size="3" face="Proxima Nova, Arial, sans-serif"><?=COption::GetOptionString("kit.b2bshop","EMAIL","")?></font></a>
                                        <!--[if !mso]><!-- -->
                                    </td>
                                </tr>
                            </table>
