...
class Opt
{
	...
	public function hasAccess()
	{
		if(self::$hasAccess === NULL)
		{
			...
			{
				$groups = unserialize(Option::get("kit.b2bshop", "OPT_BLANK_GROUPS", ""));
				if(!is_array($groups))
				{
					$groups = [];
				}
	...
	public function getBlankParams()
	{
		return [
			...
			"CACHE_TIME" => "36000000",
			"CACHE_TYPE" => "A",
			"COLOR_FROM_IMAGE" => Option::get("kit.b2bshop", "COLOR_FROM_IMAGE", "Y"),
			"COLOR_IMAGE_HEIGHT" => Option::get("kit.b2bshop", "COLOR_IMAGE_HEIGHT", "100"),
			"COLOR_IMAGE_WIDTH" => Option::get("kit.b2bshop", "COLOR_IMAGE_WIDTH", "37"),
			...
			"COLOR_IN_SECTION_LINK_MAIN" => Option::get("kit.b2bshop", "COLOR_IN_SECTION_LINK_MAIN", ""),
			"COLOR_SLIDER_COUNT_IMAGES_HOR" => Option::get("kit.b2bshop", "COLOR_SLIDER_COUNT_IMAGES_HOR", "0"),
			"COLOR_SLIDER_COUNT_IMAGES_VER" => Option::get("kit.b2bshop", "COLOR_SLIDER_COUNT_IMAGES_VER", "0"),
			"CONVERT_CURRENCY" => "Y",
			"CURRENCY_ID" => "",
			...
			"DETAIL_OFFERS_PROPERTY_CODE" => unserialize(Option::get("kit.b2bshop", "OPT_OFFER_TREE_PROPS", "")),
			...
			"DETAIL_WIDTH_BIG" => Option::get("kit.b2bshop", "DETAIL_WIDTH_BIG", ""),
			"DETAIL_WIDTH_MEDIUM" => Option::get("kit.b2bshop", "DETAIL_WIDTH_MEDIUM", ""),
			"DETAIL_WIDTH_SMALL" => Option::get("kit.b2bshop", "DETAIL_WIDTH_SMALL", ""),
			...
			"FILTER_ITEM_COUNT" => Option::get("kit.b2bshop", "FILTER_ITEM_COUNT", ""),
			...
			"FILTER_PRICE_CODE" => unserialize(Option::get("kit.b2bshop", "PRICE_CODE", "")),
			...
			"IBLOCK_ID" => Option::get("kit.b2bshop", "OPT_IBLOCK_ID", ""),
			"IBLOCK_TYPE" => Option::get("kit.b2bshop", "OPT_IBLOCK_TYPE", ""),
			"IMAGE_RESIZE_MODE" => Option::get("kit.b2bshop", "IMAGE_RESIZE_MODE", BX_RESIZE_IMAGE_PROPORTIONAL),
			"INCLUDE_SUBSECTIONS" => "Y",
			"IS_FANCY" => Option::get("kit.b2bshop", "IS_FANCY", ""),
			"LABEL_PROP" => "-",
			...
			"LINK_PROPERTY_SID" => "",
			"LIST_BROWSER_TITLE" => "-",
			"LIST_HEIGHT_MEDIUM" => Option::get("kit.b2bshop", "LIST_HEIGHT_MEDIUM", ""),
			"LIST_HEIGHT_SMALL" => Option::get("kit.b2bshop", "LIST_HEIGHT_SMALL", ""),
			...
			"LIST_OFFERS_LIMIT" => "0",
			"LIST_OFFERS_PROPERTY_CODE" => unserialize(Option::get("kit.b2bshop", "OPT_PROPS", "")),
			"LIST_PROPERTY_CODE" => [
				"",
				"NEWPRODUCT",
				"SALELEADER",
			...
			"LIST_WIDTH_MEDIUM" => Option::get("kit.b2bshop", "LIST_WIDTH_MEDIUM", ""),
			"LIST_WIDTH_SMALL" => Option::get("kit.b2bshop", "LIST_WIDTH_SMALL", ""),
			...
			"MODIFICATION" => Option::get("kit.b2bshop", "MODIFICATION", ""),
			"MODIFICATION_COUNT" => Option::get("kit.b2bshop", "MODIFICATION_COUNT", "4"),
			...
			"OFFERS_CART_PROPERTIES" => unserialize(Option::get("kit.b2bshop", "OPT_OFFER_TREE_PROPS", "")),
			...
			"OFFER_ELEMENT_PARAMS" => unserialize(Option::get("kit.b2bshop", "OFFER_ELEMENT_PARAMS", "")),
			"OFFER_ELEMENT_PROPS" => unserialize(Option::get("kit.b2bshop", "OFFER_ELEMENT_PROPS", "")),
			"OFFER_TREE_PROPS" => unserialize(Option::get("kit.b2bshop", "OPT_PROPS", "")),
			'OPT_FILTER_PROPERTIES' => unserialize(Option::get("kit.b2bshop", "OPT_FILTER_FIELDS", "")),
			'OPT_ARTICUL_PROPERTY' => Option::get("kit.b2bshop", "OPT_ARTICUL_PROP", ""),
			'OPT_ARTICUL_PROPERTY_OFFER' => Option::get("kit.b2bshop", "OPT_ARTICUL_PROP_OFFER", ""),
			'OPT_UNIQUE_PROP' => Option::get("kit.b2bshop", "OPT_UNIQUE_PROP", "CODE"),
			...
			"PAGE_ELEMENT_COUNT" => Option::get("kit.b2bshop", "CATALOG_LIST_COUNT", "12"),
			"PAGE_ELEMENT_COUNT_IN_ROW" => Option::get("kit.b2bshop", "CATALOG_LIST_COUNT_IN_ROW", "4"),
			"PARTIAL_PRODUCT_PROPERTIES" => "Y",
			"PATH_TO_SMILE" => "/bitrix/images/forum/smile/",
			"PICTURE_FROM_OFFER" => Option::get("kit.b2bshop", "PICTURE_FROM_OFFER", ""),
			"PRELOADER" => Option::get("kit.preloader", "IMAGE", ""),
			"PRICE_CODE" => ($_SESSION["KIT_REGIONS"]["PRICE_CODE"] && Option::get("kit.b2bshop", "USE_MULTIREGIONS", "Y") == 'Y')
				? $_SESSION["KIT_REGIONS"]["PRICE_CODE"] : unserialize(Option::get("kit.b2bshop", "PRICE_CODE", "")),
			"PRICE_VAT_INCLUDE" => "Y",
			...
			'SEOMETA_TAGS' => Option::get("kit.b2bshop", "SEOMETA_TAGS", "BOTTOM"),
			"SET_BROWSER_TITLE" => "Y",
			"SET_LAST_MODIFIED" => "N",
			...
			"TEL_DELIVERY_ID" => Option::get("kit.b2bshop", "TEL_DELIVERY_ID", ""),
			"TEL_MASK" => Option::get("kit.b2bshop", "TEL_MASK", "+7(999)999-99-99"),
			"TEL_PAY_SYSTEM_ID" => Option::get("kit.b2bshop", "TEL_PAY_SYSTEM_ID", ""),
			"TEMPLATE_THEME" => "blue",
			"URL_TEMPLATES_READ" => "",
			"USER_FIELDS" => [
				"",
			...
			"USE_ALSO_BUY" => "Y",
			'USE_BIG_DATA' => 'Y',
			'USE_BRICKS' => Option::get("kit.b2bshop", "SHOW_BRICKS", "N"),
			"USE_CAPTCHA" => "Y",
			"USE_COMPARE" => "N",
