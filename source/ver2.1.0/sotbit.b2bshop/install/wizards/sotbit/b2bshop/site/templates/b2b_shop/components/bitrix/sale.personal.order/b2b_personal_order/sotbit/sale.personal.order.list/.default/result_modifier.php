...
$allowActions = unserialize(Bitrix\Main\Config\Option::get('sotbit.b2bshop', 'OPT_PERSONAL_ORDER_ACTIONS', 'a:{}'));
...
$buyers = [];
$pt = unserialize(Bitrix\Main\Config\Option::get("sotbit.b2bshop","BUYER_PERSONAL_TYPE","a:0:{}"));
if(!is_array($pt))
{
	$pt = [];
}

$innProps = unserialize(Bitrix\Main\Config\Option::get('sotbit.b2bshop', 'ORDER_PROP_INN'));
...
$orgProps = unserialize(Bitrix\Main\Config\Option::get('sotbit.b2bshop', 'ORDER_PROP_ORG_NAME'));
