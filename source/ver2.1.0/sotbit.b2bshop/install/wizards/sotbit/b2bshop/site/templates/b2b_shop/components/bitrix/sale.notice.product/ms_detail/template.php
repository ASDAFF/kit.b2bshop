...
<div class="subscribe_cont">
    ...
    <div class="subscribe_new">
        ...
        <form class="subscribe_new_form" action="">
            ...
            <input type="hidden" name="popup_captcha_sid" id="popup_captcha_sid" value="<?echo $arResult["CAPTCHA_CODE"]?>" />
            <img src="/bitrix/tools/captcha.php?captcha_sid=<?echo $arResult["CAPTCHA_CODE"]?>" width="50%" height="40" alt="CAPTCHA" />
            <input class="bx-auth-input" type="text" name="popup_captcha_word" id="popup_captcha_word" maxlength="50" value="" size="15" />
            <?endif;?>
            <input type="submit" value="<?=GetMessage("MS_DETAIL_AVAILABLE_NEW_USER_SUBMIT")?>" />
        </form>
    </div>
</div>
<?return;?>
