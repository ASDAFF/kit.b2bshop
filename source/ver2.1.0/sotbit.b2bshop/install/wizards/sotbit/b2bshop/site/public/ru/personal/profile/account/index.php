...
{
	?>
	<div class="personal_block_title personal_block_title_account">
		<h1 class="text"><?
...
else
{
	...
	?>
	<div class="personal-wrapper personal-account-wrapper personal-account-wrapper-fiz <?=($opt->hasAccess())?'personal-wrapper-access':''?>">
		<?php
					...
					<div class="personal-right-content">
						...
						$APPLICATION->IncludeComponent(
							...
							Array(
								...
								"PATH_TO_BASKET" => Option::get('sotbit.b2bshop', 'URL_CART','/personal/cart/'),
								"PATH_TO_PAYMENT" => Option::get('sotbit.b2bshop', 'URL_PAYMENT','/personal/order/payment/'),
								"PERSON_TYPE" => Option::get('sotbit.b2bshop', 'PERSONAL_PERSON_TYPE','1'),
