...
if( !\Bitrix\Main\Loader::includeModule( "sotbit.b2bshop" ) || !B2BSSotbit::getDemo() )
{
	return false;
}
	...
	if( $arParams['USE_FILTER'] == 'Y' )
	{
		...
		<div class='col-sm-6 sm-padding-left-no left-wrap'>
			<div class='left-block'>
				...
				$APPLICATION->IncludeComponent( 'sotbit:catalog.smart.filter.facet', 'catalog',
						Array(
...
<div class='col-sm-18'>
	...
	if( \Bitrix\Main\Loader::includeModule( 'sotbit.mailing' ) && !\Bitrix\Main\Loader::includeModule( 'sotbit.b2bshop' ) )
	{
		?>
		<div class='col-sm-24 hidden-xs'>
			...
			<?
			$APPLICATION->IncludeComponent( 'sotbit:sotbit.mailing.email.get', 'ms_field_section',
					Array(
							'TYPE' => 'SECTION_ID',
...
if( !defined( 'ERROR_404' ) )
{
	...
	if(\Bitrix\Main\Config\Option::get("sotbit.b2bshop", "SHOW_YOU_LOOK_SECTION_UNDER","Y") == 'Y')
	{
		if(!defined('ERROR_404'))
		{
