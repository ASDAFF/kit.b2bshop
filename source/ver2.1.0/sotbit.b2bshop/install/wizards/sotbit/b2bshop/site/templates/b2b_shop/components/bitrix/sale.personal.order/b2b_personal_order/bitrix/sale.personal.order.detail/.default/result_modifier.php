...
use Sotbit\B2BShop\Client\Shop\Doc;
...
$article_prop = Option::get("sotbit.b2bshop", "OPT_ARTICUL_PROP", "");
$article_propOffers = Option::get("sotbit.b2bshop", "OPT_ARTICUL_PROP_OFFER", "");
...
if(is_object($cp))
{
	...
	if(empty($arResult['ERRORS']['FATAL']))
	{
		...
		if($offerIds)
		{
			$articulOffers = Option::get('sotbit.b2bshop', 'OPT_ARTICUL_PROP_OFFER', '');
		...
		if($prodIds)
		{
			$articulProducts = Option::get('sotbit.b2bshop', 'OPT_ARTICUL_PROP', '');
			$rs = CIBlockElement::GetList(
				["SORT" => "ASC"],
				['ID' => $prodIds],
				false,
