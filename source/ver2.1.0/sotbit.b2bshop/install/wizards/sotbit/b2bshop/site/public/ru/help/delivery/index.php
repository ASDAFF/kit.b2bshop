...
?> 
<div class="bx_page"> 	 
  <p>Интернет-магазин B2B SHOP выполняет доставку любого товара своей собственной Службой доставки.</p>
  ...
  <p><strong>Доставка товара осуществляется бесплатно.</strong> 
    <br />
   	Для стран, не входящих в Европейский Союз, в частности для Росиийской Федерации, стоимость доставки товара из нашего магазина  - 500 руб, при условии выбора при заказе товара в качестве способа доставки нашим курьером. Оплата должна быть произведена в момент доставки.</p>
  ...
  <p>Интернет-магазин B2B SHOP осуществляет доставку по всему миру совместно с курьерскими службами экспресс-доставки UPS и DHL. 
    <br />
   	 
    <br />
   Сроки доставки с момента отправки товара: 
    <br />
   
    <br />
   США и Канада: 1-3 дня, в зависимости от места назначения 
    <br />
   Европа: 1 день для крупных населенных пунктов/ 2-3 дня для отдаленных районов 
    <br />
   Латинская Америка: 3-4 дня 
    <br />
   Азия и Ближний Восток: 2-3 дня 
    <br />
   Австралия и Океания: 2-3 дня для крупных населенных пунктов/ 4-5 дня для отдаленных районов 
    <br />
   Африка: 2-4 дня 
    <br />
   
    <br />
   <strong>Интернет-магазин B2B SHOP не несёт ответственность за задержку доставки заказа, связанную с увеличением срока таможенного контроля и таможенных операций, а также чрезвычайных обстоятельств, которые не зависят от компании B2B SHOP.</strong></p>
  ...
  <p><b>Электронная почта</b>: <a href="mailto:sale@b2b-shop.sotbit.ru" >sale@b2b-shop.sotbit.ru</a></p>
