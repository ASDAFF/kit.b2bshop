...
<div class="bx-hdr-profile" >
	<div class="bx-basket-block" onmouseenter="<?=$cartId?>.toggleOpenCloseCart('open')">
		<a href="<?=(Option::get('sotbit.b2bshop','URL_PATH','ORDER') == 'ORDER')
			?$arParams['PATH_TO_ORDER']:$arParams['PATH_TO_BASKET']?>"><?=Loc::getMessage('TSB1_CART')
			?></a>
		<?
		if (!$compositeStub)
		{
			...
			{
				echo '<span><a href="';
				echo (Option::get('sotbit.b2bshop','URL_PATH','ORDER') == 'ORDER')
