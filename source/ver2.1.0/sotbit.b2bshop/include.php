...
CModule::AddAutoloadClasses('sotbit.b2bshop', array(
        'B2BSSotbitParent' => 'classes/ms_sotbit_parent.php',
        'B2BSSotbitShop' => 'classes/ms_sotbit_shop.php',
...
class B2BSSotbit
{
    ...
    function ShowPanel()
    {
        if ($GLOBALS['USER']->IsAdmin() && COption::GetOptionString('main', 'wizard_solution', '', SITE_ID) == 'b2bshop') {
            ...
            $_923747322 = array(array('ACTION' => 'jsUtils.Redirect([], \'' . CUtil::JSEscape('/bitrix/admin/wizard_install.php?lang=' . LANGUAGE_ID . '&wizardSiteID=' . SITE_ID . '&wizardName=sotbit:b2bshop&' . bitrix_sessid_get()) . '\')', 'ICON' => 'bx-popup-item-wizard-icon', 'TITLE' => GetMessage('STOM_BUTTON_TITLE_W1'), 'TEXT' => GetMessage('STOM_BUTTON_NAME_W1'),));


            $GLOBALS['APPLICATION']->AddPanelButton(array('HREF' => '/bitrix/admin/wizard_install.php?lang=' . LANGUAGE_ID . '&wizardName=sotbit:b2bshop&wizardSiteID=' . SITE_ID . '&' . bitrix_sessid_get(), 'ID' => 'eshop_wizard', 'ICON' => 'bx-panel-site-wizard-icon', 'MAIN_SORT' => 2500, 'TYPE' => 'BIG', 'SORT' => 10, 'ALT' => GetMessage('SCOM_BUTTON_DESCRIPTION'), 'TEXT' => GetMessage('SCOM_BUTTON_NAME'), 'MENU' => $_923747322,));
        ...
        if (0 && !defined('ADMIN_SECTION') || ADMIN_SECTION !== true) {
            ...
            if (isset($_REQUEST['set_filter']) && isset($_REQUEST['bxajaxid']) && $_REQUEST['set_filter'] && $_REQUEST['bxajaxid']) {
                ...
                foreach ($_REQUEST as $_391161298 => $_1387704539) {
                    ...
                    if ($_391161298 == 'set_filter' || $_391161298 == 'sotbit_filter' || $_391161298 == 'ms_viewed_products') continue;
    ...
    {
        $_966224713 = "sotbit.b2bshop";
        if (!B2BSSotbit::$_1406676796) B2BSSotbit::$_1406676796 = CModule::IncludeModuleEx($_966224713);
        {
            if (B2BSSotbit::$_1406676796 == 3) {
                return false;
            } else return true;
        }
    }
    ...
    {
        B2BSSotbit::agentSectionsBrands();
    }
    ...
    public function agentSectionsBrands()
    {
        ...
        if (!B2BSSotbit::$_168454199) B2BSSotbit::$_168454199 = COption::GetOptionString('sotbit.b2bshop', 'IBLOCK_ID');
        $_764931930 = CIBlockSection::GetList(array('left_margin' => 'asc'), array('IBLOCK_ID' => B2BSSotbit::$_168454199, 'DEPTH_LEVEL' => 1), false, array('ID'));
        $_28888307 = COption::GetOptionString('sotbit.b2bshop', 'MANUFACTURER_ELEMENT_PROPS');
        $_1178106477 = B2BSSotbit::checkCategoryUF();
        if (!$_1178106477) return 'B2BSSotbit::agentSectionsBrands();';
        while ($_1799261788 = $_764931930->Fetch()) {
            $_1681421404 = array('IBLOCK_ID' => B2BSSotbit::$_168454199, 'SECTION_ID' => $_1799261788['ID'], 'INCLUDE_SUBSECTIONS' => 'Y');
        ...
        return 'B2BSSotbit::agentSectionsBrands();';
    }

    public function checkCategoryUF()
    {
        global $APPLICATION;
        if (!B2BSSotbit::$_1574143339 && B2BSSotbit::$_168454199) {
            $_867748218 = array('ENTITY_ID' => 'IBLOCK_' . B2BSSotbit::$_168454199 . '_SECTION', 'FIELD_NAME' => 'UF_B2BS_BRAND');
            $_1335607116 = CUserTypeEntity::GetList(array('ID' => 'asc'), $_867748218)->Fetch();
            if (!$_1335607116) {
                $_1345677076['IBLOCK_TYPE_ID'] = COption::GetOptionString('sotbit.b2bshop', 'BRAND_IBLOCK_TYPE');
                $_1345677076['IBLOCK_ID'] = COption::GetOptionString('sotbit.b2bshop', 'BRAND_IBLOCK_ID');
                $_1345677076['LIST_HEIGHT'] = 10;
                $_1667127547 = new CUserTypeEntity();
                $_2006275658 = array('ENTITY_ID' => 'IBLOCK_' . B2BSSotbit::$_168454199 . '_SECTION', 'FIELD_NAME' => 'UF_B2BS_BRAND', 'USER_TYPE_ID' => 'iblock_element', 'MULTIPLE' => 'Y', 'SETTINGS' => $_1345677076);
                $_1667127547->Add($_2006275658);
                unset($_1667127547);
            }
            B2BSSotbit::$_1574143339 = 'UF_B2BS_BRAND';
            return B2BSSotbit::$_1574143339;
        } elseif (B2BSSotbit::$_168454199) return B2BSSotbit::$_1574143339;
        else return false;
    }
    ...
    public function createSocMeta($_877841411, $_1729779499, $_1482827813, $_956909620, $_1111920421)
    {
        ...
        $_877841411 = B2BSSotbit::msUrlencode($_877841411);
        $_956909620 = B2BSSotbit::msUrlencode($_956909620);
        $_1729779499 = TruncateText(strip_tags($_1729779499), 300);
        $_1729779499 = B2BSSotbit::msUrlencode($_1729779499);
    ...
    public function ExpandStringWithMacros($_1651156902, $_1864248882)
    {
        if (is_array($_1651156902)) {
            $_295404037 = array();
            foreach ($_1651156902 as $_1610659773 => $_1800172428) $_295404037[$_1610659773] = B2BSSotbit::__136825466($_1800172428, $_1864248882);
        } else {
            $_295404037 = '';
            $_295404037 = B2BSSotbit::__136825466($_1651156902, $_1864248882);
        }
        return $_295404037;
    }
            ...
            if ($_5861995 % 2 == 0) {
                ...
                if (count($_1247995260) > 1) {
                    ...
                    while (is_array($_292453156)) {
                        ...
                        $_292453156 = B2BSSotbit::__452302845($_292453156, $_1247995260[$_1651156902 + 1]);
                        ++$_1651156902;
                    }
...
';
    ...
    {
        if ($_1877535881['PERSON_TYPE_ID'] != $_1877535881['PERSON_TYPE_OLD'] && $_SESSION['SOTBIT']['DEFAULT_ORGANIZATION'] > 0 && $_1864248882['ORDER_PROP']['USER_PROFILES'][$_SESSION['SOTBIT']['DEFAULT_ORGANIZATION']]) {
            $_1877535881['PROFILE_ID'] = $_SESSION['SOTBIT']['DEFAULT_ORGANIZATION'];
            $_635159958 = \Bitrix\Sale\OrderUserProperties::getProfileValues($_SESSION['SOTBIT']['DEFAULT_ORGANIZATION']);
            ...
            $_1864248882['ORDER_PROP']['USER_PROFILES'][$_SESSION['SOTBIT']['DEFAULT_ORGANIZATION']]['CHECKED'] = 'Y';
        }
    }
