...
if(COption::GetOptionString("sotbit.b2bshop", "wizard_installed", "N", WIZARD_SITE_ID) == "N" || WIZARD_INSTALL_DEMO_DATA)
{
    ...
    COption::SetOptionString("sotbit.b2bshop",'TEL',$wizard->GetVar("siteTelephone"));
    COption::SetOptionString("sotbit.b2bshop",'COPYRIGHT',$wizard->GetVar("siteCopy"));
    COption::SetOptionString("sotbit.b2bshop",'EMAIL',$wizard->GetVar("shopEmail"));



    COption::SetOptionString("sotbit.b2bshop",'URL_CART',WIZARD_SITE_DIR.'personal/cart/');
    COption::SetOptionString("sotbit.b2bshop",'URL_ORDER',WIZARD_SITE_DIR.'personal/order/make/');
    COption::SetOptionString("sotbit.b2bshop",'URL_PERSONAL',WIZARD_SITE_DIR.'personal/');
    COption::SetOptionString("sotbit.b2bshop",'URL_PAYMENT',WIZARD_SITE_DIR.'personal/order/payment/');
    COption::SetOptionString("sotbit.b2bshop",'URL_PAGE_ORDER',WIZARD_SITE_DIR.'personal/order/');
    COption::SetOptionString("sotbit.b2bshop",'TABLE_SIZE_URL',WIZARD_SITE_DIR.'clients/table_sizes/#table');
    COption::SetOptionString("sotbit.b2bshop", 'DETAIL_TEXT_INCLUDE', GetMessage('DETAIL_TEXT_INCLUDE', array('#SITE_DIR#' => WIZARD_SITE_DIR)));
