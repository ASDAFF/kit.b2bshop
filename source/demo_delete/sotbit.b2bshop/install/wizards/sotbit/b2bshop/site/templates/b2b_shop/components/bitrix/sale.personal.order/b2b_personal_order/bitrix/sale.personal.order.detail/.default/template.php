															...
															<div class="row">
																...
																if(!$payment->isPaid())
																{
																	...
																	<div class="col-sm-24">
																		...
																		)
																		{
																			...
																			<?
																			if($arResult['PAYMENT'][$key]['PAY_SYSTEM']['ACTION_FILE'] == 'billsotbit' || $arResult['PAYMENT'][$key]['PAY_SYSTEM']['ACTION_FILE'] == 'bill')
																			{
																...
																else
																{
																	...
																	($arResult['PAYMENT'][$key]['PAY_SYSTEM']['ACTION_FILE']
																		== 'billsotbit' || $arResult['PAYMENT'][$key]['PAY_SYSTEM']['ACTION_FILE'] == 'bill')
																	{
																		$PaymentId = $payment->getId();
																		?>
																		<div class="col-sm-24">
