...
<div class="col-sm-24 sm-padding-right-no">
	<div class="inner_title_brand">
		<h1 class="text"><?=(isset($sotbitSeoMetaH1) && !empty($sotbitSeoMetaH1))?$sotbitSeoMetaH1:$arResult["NAME"]?></h1>
	</div>
</div>
<?
...
{
	if($item['CODE']==COption::GetOptionString("sotbit.b2bshop", "OFFER_COLOR_PROP", ""))
	{
	...
	if(!defined('ERROR_404'))
	{
		...
		$APPLICATION->IncludeComponent( 'bitrix:catalog.bigdata.products', 'section',
				Array(
						...
						"PRICE_CODE" => unserialize( Option::get( "sotbit.b2bshop", "PRICE_CODE", "" ) ),
						'PRICE_VAT_INCLUDE' => "Y",
