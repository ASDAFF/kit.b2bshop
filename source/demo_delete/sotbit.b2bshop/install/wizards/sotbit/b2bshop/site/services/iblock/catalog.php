...
if($IBLOCK_CATALOG_ID){
    COption::SetOptionString('sotbit.b2bshop','IBLOCK_ID',$IBLOCK_CATALOG_ID);
    //�������� ��� ������ � �������� ������
    $MAIN_PROPS = array(
        'SOSTAV',
        'CML2_ARTICLE',
    ...
    COption::SetOptionString("sotbit.b2bshop", "MAIN_PROPS", serialize($MAIN_PROPS));     
    ...
    COption::SetOptionString("sotbit.b2bshop", "DOP_PROPS", serialize($DOP_PROPS));  
  
    $ALL_PROPS = array_merge($MAIN_PROPS, $DOP_PROPS);
    COption::SetOptionString("sotbit.b2bshop", "ALL_PROPS", serialize($ALL_PROPS));
    //������� 
    $SIZE_PROPS = array(
        'RAZMER',
    );
    COption::SetOptionString("sotbit.b2bshop", "SIZE_PROPS", serialize($SIZE_PROPS));    

    
    COption::SetOptionString("sotbit.b2bshop", "PICTURE_FROM_OFFER", "Y");      
    COption::SetOptionString("sotbit.b2bshop", "DOWNLOAD", "Y");
    
    
    CModule::IncludeModule("sotbit.b2bshop");
