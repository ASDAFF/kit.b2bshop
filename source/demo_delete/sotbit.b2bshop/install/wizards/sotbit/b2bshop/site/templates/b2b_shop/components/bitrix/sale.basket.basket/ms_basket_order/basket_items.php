                ...
                <div class="row">
                    ...
                    <div class='col-sm-3 sm-padding-left-no'>
                        ...
                        <div class="wrap_input">
                            <span class="minus" onclick="minus_quantity('#QUANTITY_<?=$arItem["ID"]?>');BX.ajax
		                            .submitComponentForm(BX('basket_form'), 'basket_form_content', true);BX.submit(BX
		                            ('basket_form'));BX.closeWait();">&ndash;</span>
                            ...
                            <span class="plus" onclick="pluc_quantity('#QUANTITY_<?=$arItem["ID"]?>');BX.ajax.submitComponentForm(BX('basket_form'), 'basket_form_content', true);BX.submit(BX('basket_form'));BX.closeWait();">+</span>
                        </div>
                    </div>
                    <div class='col-sm-3'>
