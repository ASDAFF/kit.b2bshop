...
$BrandProperty = Option::get( "sotbit.b2bshop", "MANUFACTURER_ELEMENT_PROPS", "" );
$arResult["IMG_WIDTH"] = Option::get( "sotbit.b2bshop", "LIST_WIDTH_SMALL", "69" );
$arResult["IMG_HEIGHT"] = Option::get( "sotbit.b2bshop", "LIST_HEIGHT_SMALL", "116" );
$imageFromOffer = (Option::get("sotbit.b2bshop", "PICTURE_FROM_OFFER", "")=="Y")?1:0;
$ProductsId = array();
$Offers = array();
