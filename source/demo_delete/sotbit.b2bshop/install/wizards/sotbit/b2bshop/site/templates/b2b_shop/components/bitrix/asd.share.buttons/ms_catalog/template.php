...
<?if (!$arParams['ASD_ID'] && $arParams['SCRIPT_IN_HEAD']!='Y' && strlen($arResult['ASD_PICTURE_NOT_ENCODE'])){?><div style="display: none;"><img src="<?= $arResult['ASD_PICTURE_NOT_ENCODE']?>" alt="" /></div><?}?>
    ...
    <div class="block_title_share">
        <ul>
            <li><a class="social_vk" href="#" title="<?= strlen($arParams["ASD_LINK_TITLE"]) ? str_replace("#SERVICE#", GetMessage("ASD_VK"), $arParams["ASD_LINK_TITLE"]) : GetMessage("ASD_VK_TITLE")?>" onclick="window.open('http://vkontakte.ru/share.php?url=<?=$arResult["ASD_URL"]?>&amp;title=<?= $arResult["ASD_TITLE"]?>&amp;image=<?= $arResult["ASD_PICTURE"]?>&amp;description=<?= $arResult["ASD_TEXT"]?>', '', 'scrollbars=yes,resizable=no,width=560,height=350,top='+Math.floor((screen.height - 350)/2-14)+',left='+Math.floor((screen.width - 560)/2-5)); return false;"></a></li>
            <li><a class="social_fb" href="#" title="<?= strlen($arParams["ASD_LINK_TITLE"]) ? str_replace("#SERVICE#", GetMessage("ASD_FB"), $arParams["ASD_LINK_TITLE"]) : GetMessage("ASD_FB_TITLE")?>" onclick="window.open('http://www.facebook.com/sharer.php?u=<?=$arResult["ASD_URL"]?>', '', 'scrollbars=yes,resizable=no,width=560,height=350,top='+Math.floor((screen.height - 350)/2-14)+',left='+Math.floor((screen.width - 560)/2-5)); return false;"></a></li>
            <li><a class="social_twitt" href="#" title="<?= strlen($arParams["ASD_LINK_TITLE"]) ? str_replace("#SERVICE#", GetMessage("ASD_TW"), $arParams["ASD_LINK_TITLE"]) : GetMessage("ASD_TW_TITLE")?>" onclick="window.open('http://twitter.com/share?text=<?= $arResult["ASD_TITLE"]?>&amp;url=<?= $arResult["ASD_URL"]?>', '', 'scrollbars=yes,resizable=no,width=560,height=350,top='+Math.floor((screen.height - 350)/2-14)+',left='+Math.floor((screen.width - 560)/2-5)); return false;"></a></li>
            <li><a class="social_gog" href="#" title="<?= strlen($arParams["ASD_LINK_TITLE"]) ? str_replace("#SERVICE#", GetMessage("ASD_GP"), $arParams["ASD_LINK_TITLE"]) : GetMessage("ASD_GP_TITLE")?>" onclick="window.open('https://plus.google.com/share?url=<?=$arResult["ASD_URL"]?>', '', 'scrollbars=yes,resizable=no,width=560,height=350,top='+Math.floor((screen.height - 350)/2-14)+',left='+Math.floor((screen.width - 560)/2-5)); return false;"></a></li>
        </ul>
    </div>
