...
if( !empty( $arResult['ITEMS'] ) )
{
	...
	<script type="text/javascript">
		$(function() {
			if($("#block-bigdata-section").length) {

				$('#block-bigdata-section').css({'width': '100%'});
				$('#block-bigdata-section .item').css({'float': 'none'});
				$("#block-bigdata-section").owlCarousel({
					nav:true,
					smartSpeed:400,
					dots:false,
					 navText:["", ""],
		...
		$(function() {
			var msListPV = new msListProduct({
				...
				"listBlock" : "#block-bigdata-section",
				"listItem" : ".one-item",
		...
		<div class="col-sm-24 sm-padding-right-no">
			<div class="block_you_look_big">
				...
				<div class="wrap-block-you-slider">
					<div id="block-bigdata-section" class="block-you-slider block-bigdata-section">
						<?
