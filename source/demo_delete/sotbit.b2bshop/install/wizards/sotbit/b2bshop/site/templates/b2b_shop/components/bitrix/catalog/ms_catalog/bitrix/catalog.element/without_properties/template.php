					...
					<?if(isset($arResult["PRICES_JS"][$FirstOffer]) && $arResult["CAN_BUY_FIRST_OFFER"]){?>
						<div class="col-sm-12 detail_block_price_cont">
							<div class="detail_block_price">
								...
								<a class="btn_add_basket" href="#"><?=GetMessage("B2BS_CATALOG_DETAIL_IN_CART")?></a>
								<a class="btn_add_wish" href="#"><?=GetMessage("B2BS_CATALOG_DETAIL_IN_DELAY")?></a>
							</div>
						</div>
					</div>
					<?
...
{
?>
<div class="modification row without_properties-modification">
