...
<div class="bx_page"> 	 
  ...
  <p>В <b>последней колонке</b> над каждым товаром можно произвести следующие действия: либо <b>удалить</b> товар из корзины, либо <b>отложить</b> товар на будущее.</p>
  ...
  <p>Копия заказа будет выслана на ваш email, указанный при оформлении заказа.</p>
