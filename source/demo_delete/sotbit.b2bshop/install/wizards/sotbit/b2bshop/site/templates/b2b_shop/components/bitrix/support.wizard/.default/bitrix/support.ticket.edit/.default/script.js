...
function AddFileInput(mess,choose,chooseNo)
{
	...
	table.innerHTML += '<div class="support-form__upload">' +
		'<input name="FILE_'+counter+'" id="FILE_'+counter+'" type="file" multiple class="support-form__upload__file"/>' +
		'<label for="FILE_'+counter+'">'+choose+'</label>' +
		'<span>'+chooseNo+'</span>' +
		'</div><span id="files_table_'+counter+'"></span>';
}
