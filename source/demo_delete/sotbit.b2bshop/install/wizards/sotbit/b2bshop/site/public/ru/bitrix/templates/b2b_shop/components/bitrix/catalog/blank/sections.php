            ...
            <div class="col-sm-19 sm-padding-right-no blank_right-side <?= (!$menu->isOpen()) ? 'blank_right-side_full' : '' ?>" id="blank_right_side" >
                <div id="wrapper_blank_resizer" class="wrapper_blank_resizer">
                    ...
                    <div class="personal-right-content">
                        ...
                        $ids = \Bitrix\Iblock\ElementTable::getList(['order' => ['ID' => 'asc'],'filter' => ['IBLOCK_ID' => $arParams["IBLOCK_ID"]],'select' => ['ID'],'limit' => 1])->fetch();
                        $ide = \Bitrix\Iblock\ElementTable::getList(['order' => ['ID' => 'desc'],'filter' => ['IBLOCK_ID' => $arParams["IBLOCK_ID"]],'select' => ['ID'],'limit' => 1])->fetch();
                        
                        $this->SetViewTarget("blank_excel_out_filter");
                        ?>
                        <div class="col-sm-6 sm-padding-left-no">
                            <div id="blank_excel_out" class="blank_excel_out blank_excel" data-ids="<?=$ids['ID']?>"
                                 data-ide="<?=$ide['ID']?>" data-params='<?php echo Json::encode($arParams);?>' data-filter='<?php echo Json::encode(${$arParams['FILTER_NAME']});?>'>
                                <div class="blank_excel_out_text blank_excel_text"><div class="blank_excel_out_img blank_excel_img"></div>Выгрузить в Excel</div>
                            </div>
                        </div>
                        <?php
                        $this->EndViewTarget();
