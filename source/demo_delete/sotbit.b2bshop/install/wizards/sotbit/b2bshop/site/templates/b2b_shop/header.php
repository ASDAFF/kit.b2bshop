...
{
	echo Loc::getMessage('HEADER_DEMO_END',array('#MODULE#' => 'sotbit.b2bshop'));
	die;
}
...
$BRAND_IBLOCK_TYPE = Option::get("sotbit.b2bshop", "BRAND_IBLOCK_TYPE", "");
$BRAND_IBLOCK_ID = Option::get("sotbit.b2bshop", "BRAND_IBLOCK_ID", "");
$BRAND_PROP = Option::get("sotbit.b2bshop", "MANUFACTURER_ELEMENT_PROPS", "");
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
<?=Option::get("sotbit.b2bshop", "YANDEX", "")?>
<?=Option::get("sotbit.b2bshop", "GOOGLE", "")?>
