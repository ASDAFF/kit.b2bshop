                        ...
                        <div class="item_prop">
                            ...
                            if(!empty($arItem["SKU_PRODUCT"]))
                            {
                                foreach($arItem["SKU_PRODUCT"] as $arSkuData)
                                {
                                    ...
                                    <?
                                    $arOffersProps = array_merge($arOffersProps, is_array($arResult["OFFERS_ID"][$productID][$firstProp][$firstPropValue]) ? $arResult["OFFERS_ID"][$productID][$firstProp][$firstPropValue] : array());
                                }        
                            }
                            ?>
                            <?
