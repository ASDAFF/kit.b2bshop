...
if (!in_array($wizrdTemplateId, array("b2b_shop"))) {
    $wizrdTemplateId = "b2b_shop";    
} 
COption::SetOptionString("main", "wizard_template_id", $wizrdTemplateId, false, WIZARD_SITE_ID);



CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH."/bitrix/templates/b2b_shop/site_files/js/script.js", Array("SITE_DIR" => WIZARD_SITE_DIR));
CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH."/bitrix/templates/b2b_shop/components/bitrix/catalog/blank/bitrix/catalog.section/.default/script.js", Array("SITE_DIR" => WIZARD_SITE_DIR));
CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH."/bitrix/templates/b2b_shop/components/sotbit/catalog.smart.filter.facet/catalog/script.js", Array("SITE_DIR" => WIZARD_SITE_DIR));
CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH."/bitrix/templates/b2b_shop/components/sotbit/catalog.smart.filter.facet/brand/script.js", Array("SITE_DIR" => WIZARD_SITE_DIR));
CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH."/bitrix/templates/b2b_shop/components/sotbit/catalog.smart.filter.facet/blank/script.js", Array("SITE_DIR" => WIZARD_SITE_DIR));
