                        ...
                        <td align="center" width="35%">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin:0; padding:0">
                                <tr >
                                    <td width="100%">
                            <![endif]-->
                            <a href="<?=$serverName?>" target="_blank" style="color: #000000;text-decoration: none;display: block; -webkit-text-size-adjust:none;"><img src='<?=COption::GetOptionString("sotbit.b2bshop","LOGO","")?>' alt="" border="0" width="161" style="display:block;text-decoration:none; outline:none;"></a>
                            <!--[if gte mso 9]>
                            </td>
                            </tr>
                            </table>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0; padding:22px 24px 23px 24px;">
                    <tr width="100%" cellpadding="0" cellspacing="0" border="0">
                        <td width="100%">
                            ...
                            $id_props = unserialize(COption::GetOptionString("sotbit.b2bshop","OPT_PROPS",""));
                            ...
                            $arr = array(
                                0 => "NAME",
                                1 => "QUANTITY",
                                2 => COption::GetOptionString("sotbit.b2bshop","OPT_ARTICUL_PROP_OFFER","PROPERTY_CML2_ARTICLE"),
                                3 => "PRICE_FORMATED"
                            );
