...
class Widget
{
	...
	public function getBuyOrderOrgProps()
	{
		...
		$props = array();
		if(Loader::includeModule('sotbit.b2bshop') && Loader::includeModule('sale'))
		{
	...
	protected function checkOpenTab()
	{
		...
		{
			if(\Bitrix\Main\Application::getInstance()->getContext()->getRequest()->getCookieRaw('sotbit_personal_widgets_tab') == 2)
			{
				$this->openTab = 2;
			}
		}
